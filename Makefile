...
SOURCES = $(addprefix $(SRC_DIR)/, main.c net.c resources.c pcap_utils.c utils.c gateway.c host_discovery.c)
HEADERS = $(addprefix $(HEADERS_DIR)/, net.h resources.h color_output.h debug.h pcap_utils.h utils.h gateway.h host_discovery.h)
