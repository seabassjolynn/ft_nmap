...
SOURCES = $(addprefix $(SRC_DIR)/, main.c net.c resources.c pcap_utils.c gateway.c host_discovery.c scans.c arguments.c unique_ids.c queue.c)
HEADERS = $(addprefix $(HEADERS_DIR)/, net.h resources.h color_output.h debug.h pcap_utils.h gateway.h host_discovery.h scans.h arguments.h unique_ids.h queue.h)
